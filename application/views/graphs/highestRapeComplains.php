...
<div class="container-full">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 text-center v-center">
            ...
            <p class="lead">Police stations with highest rape complains</p>
            <br>
            ...
            <script>
                window.onload = function () {
                    var Url = "http://localhost/paminili.org/index.php/Statistics/getHighestRapeComplaintCountByPoliceStation";
