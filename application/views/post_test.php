            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-primary no-boder">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="text-left">
                            <div class="bg-color-blue col-md-2"><h6><img src="<?php echo base_url(); ?>assets/img/like_icon.png"/>Like 
                            <?php echo $all_posts[$i]["vote_up"] ?>
                            </h6>
                            </div>
                            <div class="col-md-2"><h6><img src="<?php echo base_url(); ?>assets/img/dislike_icon.png"/>Dislike
                            <?php echo $all_posts[$i]["vote_down"] ?>    
                            </h6></div>
                            <div class="col-md-5"><h6><img src="<?php echo base_url(); ?>assets/img/comment_icon.png"/>Comment</h6></div>
                        </div>
                        <?php $comments = $all_posts[$i]["comments"] ;
                        ...
                        <div class="col-md-12 ashbox panel">
                            ...
                            <div class="col-md-12 panel">
                                ...
                                <div class="col-md-12 font-black panel"><?php echo $comments[$j]["description"] ?></div>
                                <div class="col-md-12 text-left ashbox panel panel-small">
                                    <h6>
                                        <div class="col-md-1">Like <?php echo $comments[$j]["vote_up"] ?></div>
                                        <div class="col-md-1">Dislike <?php echo $comments[$j]["vote_down"] ?></div>
                            ...
                            <!--user reply-->
                            <?php $replies = $comments[$j]["replies"] ;
                            ...
                            <div class="col-md-10 panel">
                                ...
                                <div class="col-md-10 font-black panel"><?php echo $replies[$k]["description"] ?></div>
                                <div class="col-md-10 text-left ashbox panel panel-small">
                                    <h6>
                                        <div class="col-md-1">Like  <?php echo $replies[$k]["vote_up"] ?></div>
                                        <div class="col-md-2">Dislike <?php echo $replies[$k]["vote_down"] ?></div>
                                        <div class="col-md-1"><a data-toggle="collapse" data-parent="#accordion"
                                                                 href="#reply-box" class="">Reply</a></div>
                                    </h6>
                                </div>
